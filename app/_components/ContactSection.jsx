  ...
  const contactInfo = [
    {
      ...
      title: "Visit Us",
      details: ["123 Luxury Avenue", "Monte Carlo, MC 98000", "Monaco"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {/* Map Preview */}
            <div className="mt-10 bg-linear-to-r from-sky-500 to-purple-600 rounded-2xl p-8 text-white">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-xl font-bold mb-2">Our Location</h3>
                  <p className="text-sky-100">
                    In the heart of Lagos luxury district
                  </p>
                </div>
                <MapPin className="w-8 h-8 opacity-80" />
              </div>
              <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                <div className="aspect-video bg-linear-to-br from-white/10 to-transparent rounded-lg flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 pl-11 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    required
                    rows="6"
                    className="w-full px-4 py-3 pl-11 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all resize-none"
              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-purple-600 text-white rounded-full font-semibold hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center group"
                >
                  {isSubmitting ? (
                    <>
