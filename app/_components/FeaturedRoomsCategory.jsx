    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <Link href="/rooms">
            <button className="px-8 py-3 border-2 cursor-pointer border-gray-300 text-gray-700 rounded-full font-semibold hover:border-purple-400 hover:text-purple-600 transition-all duration-300">
