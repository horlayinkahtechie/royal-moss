...
import TeamMeeting from "@/public/images/executive-room.jpg";
import HotelLobby from "@/public/images/family-room.jpg";
import Sustainability from "@/public/images/presidential-room.jpg";

const AboutPage = () => {
  const [activeMilestone, setActiveMilestone] = useState(2024);

  const milestones = [
    { year: 2010, title: "Foundation", description: "Royal Moss Hotel was founded with a vision to redefine luxury hospitality." },
    { year: 2013, title: "First Award", description: "Received our first 5-star rating and Luxury Hotel of the Year award." },
    { year: 2016, title: "Global Expansion", description: "Opened our second property in Dubai, marking international presence." },
    { year: 2019, title: "Sustainability Leader", description: "Achieved carbon-neutral certification across all properties." },
    { year: 2022, title: "Innovation Hub", description: "Launched our digital concierge and smart room technology." },
    { year: 2024, title: "Industry Pioneer", description: "Introduced AI-powered personalized guest experiences." },
  ];
  ...
  const coreValues = [
    {
      ...
      description: "We believe in creating unforgettable experiences through personalized, anticipatory service.",
      color: "text-rose-500",
      bgColor: "bg-rose-50"
    },
    {
    ...
    },
    {
      ...
      description: "We combine local authenticity with international standards of luxury.",
    ...
    },
    {
      ...
      description: "We're committed to environmental stewardship without compromising on luxury.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Redefining <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-purple-300">Luxury</span> Hospitality
              </h1>
              
              <p className="text-xl text-white/90 mb-8 max-w-2xl">
                For years, Royal Moss has been at the forefront of luxury hospitality, 
                blending timeless elegance with modern innovation to create unforgettable experiences.
              </p>
  ...
  />
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2010, Royal Moss began as a dream to create a sanctuary 
                where luxury meets genuine hospitality. What started as a single 
                property has grown into an internationally acclaimed brand, recognized 
                for our commitment to excellence and innovation.
              </p>
              
              <p className="text-lg text-gray-600 mb-8">
                We've consistently pushed boundaries while maintaining the timeless 
                elegance that defines true luxury. From pioneering sustainable practices 
                to introducing cutting-edge guest technology, our journey reflects our 
                dedication to evolving with our guests' needs.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-0 right-0 top-8 h-0.5 bg-gradient-to-r from-sky-400 via-purple-400 to-pink-400 hidden lg:block"></div>
              ...
              {milestones.map((milestone) => (
                ...
                >
                  <div className={`text-center transition-all duration-300 ${
                    activeMilestone === milestone.year ? 'scale-110' : 'scale-100'
                  }`}>
                    <div className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4 transition-all duration-300 ${
                      activeMilestone === milestone.year 
                        ? 'bg-gradient-to-r from-sky-600 to-purple-600 text-white shadow-xl' 
                    ...
                    <h3 className={`font-bold text-lg mb-2 transition-colors ${
                      activeMilestone === milestone.year ? 'text-sky-600' : 'text-gray-900'
                    }`}>
                      {milestone.title}
                    </h3>
            ...
            {leadershipTeam.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="text-sky-600 font-medium mb-3">{member.role}</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                {awards.map((award, index) => (
                  <div key={index} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">International Luxury Hotel Awards</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-br from-sky-600 to-purple-600 rounded-3xl p-8 text-white">
      ...
      <section className="py-20 bg-gradient-to-r from-sky-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto">
            Join thousands of discerning travelers who have made Royal Moss their 
            preferred choice for luxury accommodation.
          </p>
