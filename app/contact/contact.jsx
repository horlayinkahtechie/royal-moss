        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {contactMethods.map((method, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 ${method.bgColor} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {!isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none min-h-37.5 resize-none"
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    ...
                    inquiry within 2 hours during business hours.
                  </p>
            ...
            <div className="space-y-8">
              {/* Map Placeholder */}
              <div className="bg-linear-to-br from-sky-600 to-purple-600 rounded-3xl overflow-hidden shadow-xl">
