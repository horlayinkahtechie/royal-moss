...
const Gallery = () => {
  ...
  const galleryImages = Array.from({ length: 16 }, (_, i) => ({
    id: i + 1,
    category: ["rooms", "dining", "spa", "events", "exterior", "lifestyle"][
      i % 6
    ],
    title: [
      "Presidential Suite",
              ...
              {filteredImages.map((image) => (
                ...
                >
                  ...
                  <div className="aspect-4/3 relative overflow-hidden">
                    ...
                    {/* Featured Badge */}
                    {image.featured && (
                      <div className="absolute top-4 left-4 bg-linear-to-r from-amber-400 to-orange-500 text-white px-3 py-1 rounded-full text-xs font-bold">
                        FEATURED
                      </div>
                    )}
              ...
              <div className="lg:w-1/3 p-8 overflow-y-auto">
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  <p className="text-sm text-gray-500">
                    © 2024 Royal Moss Hotel. All rights reserved. This image may
