...
export default function Availability() {
  ...
  const fetchRooms = async () => {
    ...
    try {
      ...
      // Format room data with dynamic availability based on dates
  ...
  const checkRoomAvailability = (room, checkIn, checkOut) => {
    ...
    for (const booking of room.bookings) {
      ...
      if (
        (requestedCheckIn >= bookedCheckIn &&
          requestedCheckIn < bookedCheckOut) ||
        (requestedCheckOut > bookedCheckIn &&
          requestedCheckOut <= bookedCheckOut) ||
        (requestedCheckIn <= bookedCheckIn &&
          requestedCheckOut >= bookedCheckOut)
      ) {
        return false;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Header */}
        <div className="bg-linear-to-r from-sky-600 to-purple-600 pt-32 pb-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <button
              onClick={() => router.back()}
              ...
              <div className="mt-6 lg:mt-0">
                <div className="flex items-center space-x-4 text-white">
                  <div className="flex items-center">
                    ...
                    <span>
                      {rooms.filter((r) => r.availability).length} Available
                    </span>
                  </div>
                  <div className="flex items-center">
                    <XCircle className="w-5 h-5 mr-2 text-rose-300" />
                    <span>
                      {rooms.filter((r) => !r.availability).length} Occupied
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="relative max-w-6xl w-full max-h-[90vh] overflow-y-auto bg-white rounded-3xl shadow-2xl">
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="lg:w-2/3 relative">
                  <div className="aspect-video lg:aspect-auto lg:h-[70vh] relative overflow-hidden">
                    {selectedRoom.images.length > 0 ? (
                      ...
                      <div className="w-full h-full bg-linear-to-br from-sky-400 to-purple-500 flex items-center justify-center">
                        <div className="text-white text-center">
                          <div className="text-4xl font-bold opacity-20 mb-2">
                            Royal Moss
                          </div>
                ...
                <div className="lg:w-1/3 p-8 overflow-y-auto">
                  ...
                  {/* Pricing */}
                  <div className="mb-8 p-6 bg-linear-to-r from-sky-50 to-purple-50 rounded-2xl">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <div className="text-sm text-gray-600">
                          Starting from
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div className="flex items-center space-x-4">
                      <button className="flex items-center cursor-pointer px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                        <Phone className="w-4 h-4 mr-2" />
                        Call Us
                      </button>
                      <button className="flex items-center cursor-pointer px-4 py-2 bg-sky-100 text-sky-700 rounded-lg hover:bg-sky-200 transition-colors">
